...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('external', 'External link'), ('insight', 'Insight'), ('software', 'Installation instructions for software'), ('workshop', 'Workshop'), ('cheatsheet', 'Cheat sheet')], default='external', max_length=10)),
