    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('uncategorized', 'Uncategorized'), ('reading', 'Reading'), ('project', 'Project'), ('tutorial', 'Tutorial'), ('cheatsheet', 'Cheatsheet'), ('dataset', 'Dataset')], default='uncategorized', max_length=13)),
            ],
            options={
