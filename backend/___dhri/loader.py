...
from backend.logger import Logger, get_or_default
...
from backend.settings import NORMALIZING_SECTIONS, FORCE_DOWNLOAD, BACKEND_AUTO, \
...
from backend.settings import GLOSSARY_REPO
