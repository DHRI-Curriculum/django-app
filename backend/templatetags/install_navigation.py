...
def install_navigation(context):
    ...
    html = '<div class="navbar p-0 ml-2">'
    html += f'<a class="mr-0 mr-sm-3 text-white btn btn-sm" href="{reverse("install:index")}"><strong>Installations</strong></a>'

    # By software
    html += '<div style="position: relative !important;"><a class="mr-0 mr-sm-3 text-white btn btn-sm dropdown-toggle" href="#" id="installBySoftware" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">By Software</a>'
    ...
    # By OS
    html += '<div style="position: relative !important;"><a class="mr-0 mr-sm-3 text-white btn btn-sm dropdown-toggle" href="#" id="installByOS" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">By Operating System</a>'
