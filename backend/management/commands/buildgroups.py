...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if log._save(data='buildgroups', name='warnings.md', warnings=True) or log._save(data='buildgroups', name='logs.md', warnings=False, logs=True) or log._save(data='buildgroups', name='info.md', warnings=False, logs=False, info=True):
