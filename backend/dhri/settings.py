...
SETUP['backend.yml']['STATIC_IMAGES'] = {key: Path(value) for key, value in SETUP['backend.yml']['STATIC_IMAGES'].items()}
SETUP['backend.yml']['TEST_AGES'] = {key: timedelta(days=value) for key, value in SETUP['backend.yml']['TEST_AGES'].items()}
