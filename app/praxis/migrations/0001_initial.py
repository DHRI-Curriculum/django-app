# Generated by Django 3.0.7 on 2020-07-07 00:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('further_readings', models.ManyToManyField(to='library.Reading')),
                ('more_projects', models.ManyToManyField(to='library.Project')),
                ('more_resources', models.ManyToManyField(to='library.Resource')),
