...
var top_menu_collapse = () => {
    return bootstrap.Collapse.getInstance(top_menu);
};
var all_workshops_collapse = () => {
    return bootstrap.Collapse.getInstance(all_workshops);
};
var all_installations_collapse = () => {
    return bootstrap.Collapse.getInstance(all_installations);
};
var all_insights_collapse = () => {
    return bootstrap.Collapse.getInstance(all_insights);
};
