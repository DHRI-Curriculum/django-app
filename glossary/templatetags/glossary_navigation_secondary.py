...
def glossary_navigation_secondary(context):
    ...
    html = '''
            <a class="text-white d-block d-sm-none nav-link dropdown-toggle" href="#" id="GlossaryNavDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Navigate to letter</a>
